...
class SuitPlannerBase:
    ...
    SuitHoodInfo = [
        # Zone, Min, Max, Bmin, Bmax, BWeight, SMax, JChance, Track, Lvl, Heights
        [2100, 10, 18, 0, 30, 20, 3, (1, 5, 10, 40, 60, 80), (45, 25, 5, 25), (1, 2, 3), []],
        [2200, 10, 18, 0, 30, 15, 3, (1, 5, 10, 40, 60, 80), (10, 70, 10, 10), (1, 2, 3), []],
        [2300, 10, 18, 0, 30, 15, 3, (1, 5, 10, 40, 60, 80), (10, 10, 40, 40), (1, 2, 3), []],
        [1100, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (90, 10, 0, 0), (2, 3, 4), []],
        [1200, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 90, 10), (3, 4, 5, 6), []],
        [1300, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (40, 40, 10, 10), (3, 4, 5, 6), []],
        [3100, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (90, 10, 0, 0), (5, 6, 7), []],
        [3200, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (10, 20, 30, 40), (5, 6, 7), []],
        [3300, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 85, 5, 5), (7, 8, 9), []],
        [4100, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 50, 50), (2, 3, 4), []],
        [4200, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 90, 10), (3, 4, 5, 6), []],
        [4300, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 50, 0, 0), (3, 4, 5, 6), []],
        [5100, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 20, 10, 70), (2, 3, 4), []],
        [5200, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (10, 70, 0, 20), (3, 4, 5, 6), []],
        [5300, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 5, 85), (3, 4, 5, 6), []],
        [9100, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (25, 25, 25, 25), (6, 7, 8, 9), []],
        [9200, 10, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 85, 5), (6, 7, 8, 9), []],
        [10000, 10, 15, 0, 5, 15, 3, (1, 5, 10, 40, 60, 80), (100, 0, 0, 0), (7, 8, 9, 10), []],
        [11000, 10, 15, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100), (4, 5, 6), []],
        ...
        [19000, 10, 15, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (25, 25, 25, 25), (8, 9, 10), []]
    ]
    ...
    def delete(self):
        self.dnaStore = None
        self.pointIndexes = {}
        del self.streetPointList[:]
        del self.frontdoorPointList[:]
        del self.sidedoorPointList[:]
        del self.cogHQDoorPointList[:]

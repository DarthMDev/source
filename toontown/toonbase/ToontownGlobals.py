...
InstanceToDept = {
    SellbotFactoryInt: 'sellbot',
    CashbotMintIntA: 'cashbot',
    CashbotMintIntB: 'cashbot',
    CashbotMintIntC: 'cashbot',
    LawbotStageIntA: 'lawbot',
    LawbotStageIntB: 'lawbot',
    LawbotStageIntC: 'lawbot',
    LawbotStageIntD: 'lawbot',
    BossbotCountryClubIntA: 'bossbot',
    BossbotCountryClubIntB: 'bossbot',
    BossbotCountryClubIntC: 'bossbot'
}
InstanceToUniqueName = {
    SellbotFactoryInt: 'factory',
    CashbotMintIntA: 'coin-mint',
    CashbotMintIntB: 'dollar-mint',
    CashbotMintIntC: 'bullion-mint',
    LawbotStageIntA: 'office-a',
    LawbotStageIntB: 'office-b',
    LawbotStageIntC: 'office-c',
    LawbotStageIntD: 'office-d',
    BossbotCountryClubIntA: 'front-three',
    BossbotCountryClubIntB: 'middle-six',
    BossbotCountryClubIntC: 'back-nine'
}
HQToSafezone = {

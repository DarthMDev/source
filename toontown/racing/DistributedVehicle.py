...
class DistributedVehicle(DistributedSmoothNode.DistributedSmoothNode, Kart.Kart, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        for wallHit in self.SFX_WallHits:
            self.wallHitsSfx.append(loader.loadSfx(wallHit))

        self.skidLoopAsphaltSfx = loader.loadSfx(self.SFX_SkidLoop_Asphalt)
        self.skidLoopAsphaltSfx.setLoop()
        self.skidLoopGrassSfx = loader.loadSfx(self.SFX_SkidLoop_Grass)
        self.skidLoopGrassSfx.setLoop()
        self.turboStartSfx = loader.loadSfx(self.SFX_TurboStart)
        self.turboLoopSfx = loader.loadSfx(self.SFX_TurboLoop)

...
# Mailbox
mailbox = Actor('phase_5/models/char/tt_r_ara_ttc_mailbox.bam',{"boost": 'phase_5/models/char/tt_a_ara_ttc_mailbox_fightBoost.bam', "idle": 'phase_5/models/char/tt_a_ara_ttc_mailbox_fightIdle.bam'})
...
def waitForPreloading(task):
    ...
    cameraZoomInterval = camera.posInterval(1.3,
                                           Point3(-309.92, -114.49, 2.5),
                                           startPos=Point3(-304.92, -120.49, 3.5))

    cameraShiftRightInterval = camera.posInterval(0.7,
                                           Point3(-302.92, -112.49, 2.5),
                                           startPos=Point3(-309.92, -114.49, 2.5))

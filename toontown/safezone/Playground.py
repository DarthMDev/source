...
class Playground(BattlePlace.BattlePlace):
    ...
    def enter(self, requestStatus):
        ...
        self.enableTimeEffects()
        how = requestStatus['how']
        if how == 'teleportIn':
            how = 'deathAck'
        self.fsm.request(how, [requestStatus])

    def shardTimeTick(self):
        self.loader.hood.processTime()

    def enableTimeEffects(self):
        # We want to call shardTimeTick manually and then we can accept the 'time-tick' message.
        self.shardTimeTick()
        self.accept('time-tick', self.shardTimeTick)

    def disableTimeEffects(self):
        self.ignore('time-tick')

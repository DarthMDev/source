...
badBlocks = [
    1707, 2602, 2605, 2606, 2701, 2704, 2705, 2708, 2803, 2804, 2805, 2809,
    3605, 3703, 5607, 5609
]
...
FOnpcFriends = {
 ...
 9309: (ToontownBattleGlobals.SOUND_TRACK,
        ...
        40,
        3),
 9310: (ToontownBattleGlobals.NPC_COGS_MISS,
        1,
        0,
        2),
 9311: (ToontownBattleGlobals.NPC_TOONS_HIT,
        1,
        0,
        2),
 9312: (ToontownBattleGlobals.TRAP_TRACK,
        4,
        40,
        2)}

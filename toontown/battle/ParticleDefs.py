...
def rain(self):
    ...
    # Sprite parameters
    p0.renderer.setTexture(loader.loadTexture('phase_3.5/maps/rain_particle.png'))
    p0.renderer.setColor(Vec4(1.00, 1.00, 1.00, 1.00))
    p0.renderer.setXScaleFlag(1)
    p0.renderer.setYScaleFlag(1)
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0.0030)
    p0.renderer.setFinalXScale(0.0030)
    p0.renderer.setInitialYScale(0.0070)
    p0.renderer.setFinalYScale(0.0070)
    p0.renderer.setNonanimatedTheta(350.0000)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPNOBLEND)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETEXPLICIT)
    ...
    p0.emitter.setExplicitLaunchVector(Vec3(0.0000, 0.0000, -40.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Volume parameters
    p0.emitter.setRadius(500.0000)
    self.addParticles(p0)
...
def bossCogFrontAttackC(self):
    ...
    p0.emitter.setAmplitude(5.0000)
    p0.emitter.setAmplitudeSpread(0.0000)
    p0.emitter.setOffsetForce(Vec3(-10.0000, 0.0000, 0.0000))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0000, 0.0000, 0.0000))
    p0.emitter.setRadiateOrigin(Point3(0.0000, 0.0000, 0.0000))
    # Sphere Surface parameters
    p0.emitter.setRadius(1.0000)
...
def floatingHearts(self):
    ...
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAOUT)
    p0.renderer.setUserAlpha(0.40)
    # Sprite parameters
    p0.renderer.addTextureFromFile('phase_3.5/maps/hearts.png')
    p0.renderer.setColor(Vec4(1.00, 1.00, 1.00, 1.00))
    p0.renderer.setXScaleFlag(0)
    p0.renderer.setYScaleFlag(0)
    p0.renderer.setAnimAngleFlag(0)

...
OriginalHolidays = {
    ...
    { 'startAndEndPairs':       [datetime.datetime( datetime.datetime.now().year, Month.AUGUST,    23,   0,  0o1),          # Stage 1 animates
                                         datetime.datetime( datetime.datetime.now().year, Month.SEPTEMBER,  19,   23,  59),],
      'phaseDates': [datetime.datetime( datetime.datetime.now().year, Month.AUGUST,   20,   00,  0o1),            # Stage 4 animates
                     ],
    },
...
#        ),
    ...
    holidaysEnglish = {
        ...
        # INAUTH: Storm Sellbot did not happen yearly in the original Toontown Online.
        ToontownGlobals.SELLBOT_NERF_HOLIDAY: HolidayInfo_Yearly(
        None,
        [(Month.AUGUST, 25, 0, 0, 1),
         (Month.SEPTEMBER, 21, 23, 59, 59)],
        displayOnCalendar = True,
        ),
...
#        ),
        ...
        ToontownGlobals.JELLYBEAN_TROLLEY_HOLIDAY_MONTH: HolidayInfo_Yearly(
        None,
        [(Month.AUGUST, 20, 0, 0, 1),
         (Month.SEPTEMBER, 19, 23, 59, 59)],
        displayOnCalendar = False,
        ),

        ToontownGlobals.JELLYBEAN_FISHING_HOLIDAY_MONTH: HolidayInfo_Yearly(
        None,
        [(Month.AUGUST, 20, 0, 0, 1),
         (Month.SEPTEMBER, 19, 23, 59, 59)],
        displayOnCalendar = False,
        ...
        ToontownGlobals.JELLYBEAN_PARTIES_HOLIDAY_MONTH: HolidayInfo_Yearly(
        None,
        [(Month.AUGUST, 20, 0, 0, 1),
         (Month.SEPTEMBER, 19, 23, 59, 59)],
        displayOnCalendar = False,
        ...
        ToontownGlobals.SPOOKY_BLACK_CAT: HolidayInfo_Yearly(
        None,
        [(Month.SEPTEMBER, 13, 0, 0, 1),
         (Month.SEPTEMBER, 13, 23, 59, 59)],
        displayOnCalendar = False,
        ),

        ToontownGlobals.SPOOKY_TRICK_OR_TREAT: HolidayInfo_Yearly(
        TrickOrTreatMgrAI.TrickOrTreatMgrAI,
        [(Month.AUGUST, 30, 0, 0, 1),
         (Month.SEPTEMBER, 5, 23, 59, 59)],
        displayOnCalendar = False,
        ),

        ToontownGlobals.SPOOKY_PROPS: HolidayInfo_Yearly(
        None,
        [(Month.AUGUST, 30, 0, 0, 1),
         (Month.SEPTEMBER, 5, 23, 59, 59)],
        displayOnCalendar = False,
        ...
        ToontownGlobals.SPOOKY_COSTUMES: HolidayInfo_Yearly(
        CostumeManagerAI.CostumeManagerAI,
        [(Month.AUGUST, 30, 0, 0, 1),
         (Month.SEPTEMBER, 5, 23, 59, 59)],
        displayOnCalendar = False,
        ...
        ToontownGlobals.WACKY_WINTER_DECORATIONS: HolidayInfo_Yearly(
        None, # No class defined, we just want the news manager to be called
        [(Month.SEPTEMBER, 6, 0, 0, 1),
         (Month.SEPTEMBER, 13, 23, 59, 59)],
        displayOnCalendar = False,
        ),

        ToontownGlobals.WACKY_WINTER_CAROLING: HolidayInfo_Yearly(
        WinterCarolingMgrAI.WinterCarolingMgrAI,
        [(Month.SEPTEMBER, 6, 0, 0, 1),
         (Month.SEPTEMBER, 13, 23, 59, 59)],
        displayOnCalendar = False,
        ...
        ToontownGlobals.COLD_CALLER_INVASION: HolidayInfo_Yearly(
        HolidaySuitInvasionManagerAI.HolidaySuitInvasionManagerAI,
...
#        holidaysCommon.update(holidaysPortuguese)
    ...
    if not language in ['japanese', 'german', 'portuguese', 'french'] :
        ...
        if ConfigVariableBool('want-trolley-holiday', 0).getValue():

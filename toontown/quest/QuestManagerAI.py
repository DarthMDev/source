...
class QuestManagerAI:
    ...
    QuestCheat = ConfigVariableBool("quest-cheat", False).getValue()
    ...
    def isQuestComplete(self, av, npc, questDesc) -> bool:
    ...
    def needsQuest(self, av) -> bool:
        # Return False if this avatar does not need a new quest, True if he does
        quests = av.quests
    ...
    def incrementReward(self, av) -> bool:
